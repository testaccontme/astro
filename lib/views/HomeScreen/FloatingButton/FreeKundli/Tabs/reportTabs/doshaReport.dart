...
import 'package:astrowaypartner/views/HomeScreen/FloatingButton/FreeKundli/Tabs/reportTabs/kalsarpaDosha.dart';
import 'package:astrowaypartner/views/HomeScreen/FloatingButton/FreeKundli/Tabs/reportTabs/manglikDosh.dart';
import 'package:astrowaypartner/views/HomeScreen/FloatingButton/FreeKundli/Tabs/reportTabs/sadesatiDosha.dart';
                  ...
                  return InkWell(
                    ...
                    child: Padding(
                      ...
                      child: Container(
                          ...
                          child: Text(kundliController.doshaTab[index].title, style: const TextStyle(fontSize: 13))),
                    ),
                  );
                }),
          ),
